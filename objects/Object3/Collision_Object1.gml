...
if(place_meeting(x,y,Object1)){
	...
	if (ry < 350) {
		if (Object1.x > 650) {
			instance_create_layer(random_range(544,736), ry, "Instances_1",Object3)	
		}
		else {
			instance_create_layer(random_range(928,1120), ry, "Instances_1",Object3)	
		}
	}
	else if (ry > 512) {
		if (Object1.x > 650) {
			instance_create_layer(random_range(192,384), ry, "Instances_1",Object3)	
		}
		else {
			instance_create_layer(random_range(896,1216), ry, "Instances_1",Object3)	
		}
	}
		...
		if (Object1.x > 650) {
			...
			instance_create_layer(random_range(768,896), ry, "Instances_1",Object3)	
		}
	}
	else  {
		if (Object1.x > 650) {
			instance_create_layer(random_range(192,512), ry, "Instances_1",Object3)	
		}
		else {
			instance_create_layer(random_range(896,1216), ry, "Instances_1",Object3)	
		}
	}
	with(Object4) {sz = 0; image_xscale = 1;}
	with(Object5) {cr += 1;}
}
